...
$config['licenseName'] = 'delivery.local';
$config['licenseKey']  = '2WUWX4V9NUPHJPSL5L5553SGHH7C3';
...
$config['backends']['default'] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => config('app.url').'/uploads/userfiles',
    'root'         => public_path('/uploads/userfiles'),
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
