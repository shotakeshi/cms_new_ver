  ...
  <div class="row">
    ...
    <div class="col-lg-5">
      <div class="text-center">
        ...
        <div class="btn-group clearfix w-100 mb-3">
        ...
        <div class="d-flex mb-3">
          ...
          <button class="btn btn-warning w-50 mr-1" onclick="performCropNew()">{{ trans('laravel-filemanager::lfm.btn-copy-crop') }}</button>
          <button class="btn btn-primary w-50" onclick="performCrop()">{{ trans('laravel-filemanager::lfm.btn-crop') }}</button>
        </div>
        <form id='cropForm'>
