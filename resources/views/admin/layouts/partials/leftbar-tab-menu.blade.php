    ...
    <div class="main-icon-menu slimscroll-menu">
        ...
        <div class="pro-metrica-end">
            ...
            <a href="#" class="profile">
                <img src="{{ showImage(Auth::guard('admin')->user()->avatar) }}" alt="profile-user" class="rounded-circle thumb-sm">
            </a>
        </div>
    ...
    <div class="main-menu-inner">
        ...
        <div class="topbar-left">
            <a href="{{ url('/admin/dashboard') }}" class="logo">
                <img src="{{ asset('administrator/assets/images/logo-text.png') }}" alt="logo-small" style="max-height: 150px">
            </a>
        </div>
        <!--end logo-->
        <div class="menu-body slimscroll">
            <div id="MetricaDashboard" class="main-icon-menu-pane active">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ route('departments.index') }}">Deparment</a></li>
