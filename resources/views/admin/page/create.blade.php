...
@section('content')
    ...
    @include('admin.layouts.partials.page-title-box', ['name' => __('site.page.create_title'), 'url' =>  route('pages.index')])
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="meta_keywords" class="col-form-label">{{ __('site.tags') }}</label>
                                        <div class="u-tagsinput">
                                            <input name="tags" class="form-control w-100" type="text" data-role="tagsinput" value="{{ old('tags') }}" placeholder="{{ __('site.tags') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <button type="submit" name="submitter" onclick="$('#page').submit()" value="save_and_exit" class="btn btn-lg btn-gradient-purple w-100"><i class="fas fa-sign-out-alt"></i> {{ __('site.button.save_and_exit') }}</button>
                        </div>
                    </div>
                </div>
            </div>
