...
return [
    ...
    */
    ...
    'ascii' => 'Trường :attribute chỉ được chứa các ký tự ASCII đơn byte.',
    ...
    'hex_color' => 'Trường :attribute phải là một màu sắc thập lục phân hợp lệ.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Giá trị :attribute đã xuất hiện trong một vi phạm dữ liệu. Vui lòng chọn giá trị khác.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'mật khẩu',
        'code' => 'mã vùng',
        'values.vi' => 'giá trị tiếng Việt',
        'values.en' => 'giá trị tiếng Anh'
    ],
];
