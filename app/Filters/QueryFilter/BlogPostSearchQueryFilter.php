...
class BlogPostSearchQueryFilter extends QueryFilterAbstract implements QueryFilterInterface
{
    /**
    ...
    **/
    public function handle(Builder $builder, $value): Builder
    {
        ...
        return $builder->withWhereHas('contents', function (Builder $builder) use ($value) {
            $builder->janoLike('name', $value);
        });
    }
}
